...
{
    // SQLite in-memory instead of the InMemory provider: AuthService.LoginAsync uses
    // ExecuteDeleteAsync (expired-token housekeeping), which InMemory can't translate.
